...
<head>
  ...
  <title>Ramz Library | Register</title>
  ...
  <main
    ...
    <div class="w-full md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
      <div class="max-w-md w-full mx-auto space-y-8">
        ...
        <div class="space-y-2">
          <h1 class="text-4xl font-bold text-white tracking-tight">Create an account</h1>
          <p class="text-slate-400 font-medium">Please fill the form for create library account.</p>
        </div>
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-6">
          ...
          <div class="flex flex-col gap-2">
            <label for="email" class="text-sm font-medium text-slate-300">Username</label>
          ...
          <div class="flex flex-col gap-2">
            <label for="password" class="text-sm font-medium text-slate-300">Confirm Password</label>
          ...
          <button type="submit"
            class="w-full py-3 bg-[#4379EE] text-white font-semibold text-lg rounded-xl hover:bg-blue-700 focus:ring-4 focus:ring-blue-500/50 transition-all duration-200">
            Register
          </button>
        </form>
        ...
        <p class="text-center text-slate-400">
          Have an account?
          <a href="/auth/login"
            class="text-blue-400 hover:text-blue-300 font-semibold underline underline-offset-4 transition-colors">Login</a>
        </p>
