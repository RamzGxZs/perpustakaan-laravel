...
<body class="min-h-screen flex items-center justify-center p-4 sm:p-8">
  ...
  <main class="w-full max-w-6xl bg-[#1e293b] rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row border border-slate-700/50">
    ...
    <div class="w-full md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
      <div class="max-w-md w-full mx-auto space-y-8">
        ...
        <p class="text-center text-slate-400">
          ...
          <a href="/auth/register" class="text-blue-400 hover:text-blue-300 font-semibold underline underline-offset-4 transition-colors">Register</a>
        </p>
